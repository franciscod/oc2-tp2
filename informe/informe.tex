...
\includegraphics[width=15cm, keepaspectratio]{problema_circulos_columnas.png} \\
...
\begin{tikzpicture}
  \begin{axis}[title  = Figura 1 - Cantidad de clocks filtro Diff,
    xbar,
...
\begin{tikzpicture}
  \begin{axis}[title  = Figura 2 - Cantidad de clocks filtro Blur,
    xbar,
    y axis line style = { opacity = 0 },
    axis x line       = none,
    tickwidth         = 0pt,
...
\begin{tikzpicture}
  \begin{axis}[title  = Figura 3 - Cantidad de clocks optimización -O3,
    xbar,
    y axis line style = { opacity = 0 },
    axis x line       = none,
    tickwidth         = 0pt,
