...
En la figura 5 podemos ver que, al considerar el tiempo por pixel, la imagen más chica se procesa más rapido. Esto probablemente se deba a que entra mejor en la caché del microprocesador al ser mas pequeña. \\
...
\begin{center}
\begin{tikzpicture}
  \begin{axis}[title  ={ Figura 4 - Cantidad de clocks (toda la imagen), filtro Blur},
    xbar,
    y axis line style = { opacity = 0 },
    axis x line       = none,
    tickwidth         = 0pt,
...
\begin{center}
\begin{tikzpicture}
  \begin{axis}[title  ={ Figura 5 - Cantidad de clocks (por pixel), filtro Blur},
    xbar,
    y axis line style = { opacity = 0 },
    axis x line       = none,
    tickwidth         = 0pt,
