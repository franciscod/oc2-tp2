...
\begin{center}
\begin{tikzpicture}
  \begin{axis}[title  ={ Figura 3 - Cantidad de clocks (toda la imagen), Blur con optimización -O3},
    xbar,
    y axis line style = { opacity = 0 },
    axis x line       = none,
    tickwidth         = 0pt,
...
\begin{center}
\begin{tikzpicture}
  \begin{axis}[title  ={ Figura 4 - Cantidad de clocks (por pixel), Blur con optimización -O3},
    xbar,
    y axis line style = { opacity = 0 },
    axis x line       = none,
    tickwidth         = 0pt,
